...
library PermissionsData {
  ...
  address internal constant ADDRESSES_PROVIDER_REGISTRY_OPTIMISM =
    0x770ef9f4fe897e59daCc474EF11238303F9552b6;
  ...
  function _getPermissionsSourcesArb() internal pure returns (AavePermissionsSources memory) {
    return
      AavePermissionsSources({
        ...
        addressesProviderRegistry: address(ADDRESSES_PROVIDER_REGISTRY_ARBITRUM),
  ...
  function _getPermissionsSourcesOp() internal pure returns (AavePermissionsSources memory) {
    return
      AavePermissionsSources({
        ...
        addressesProviderRegistry: address(ADDRESSES_PROVIDER_REGISTRY_OPTIMISM),
...
abstract contract BaseAavePermissionsHelper is Script {
