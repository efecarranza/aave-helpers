...
contract AaveSwapperTest is Test {
  ...
  function setUp() public virtual {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 21358703);
...
contract CancelSwap is AaveSwapperTest {
  ...
  function test_successful() public {
    ...
    swaps.cancelSwap(
      0x1D18380041Ba52ef4011e8264E2F9605D7a023Fe, // Address generated by tests
      CHAINLINK_PRICE_CHECKER,
      AaveV2EthereumAssets.AAVE_UNDERLYING,
      AaveV2EthereumAssets.USDC_UNDERLYING,
      AaveV2EthereumAssets.AAVE_ORACLE,
...
contract GetExpectedOut is AaveSwapperTest {
  ...
  function test_aaveToUsdc_withEthBasedOracles() public view {
    ...
    // December 8, 2024 AAVE/USD is around $281
    assertEq(expected / 1e4, 28157); // USDC is 6 decimals
  }
  ...
  function test_aaveToUsdc() public view {
    ...
    // December 8, 2024 AAVE/USD is around $278
    assertEq(expected / 1e4, 27846); // USDC is 6 decimals
  }
  ...
  function test_ethToDai() public view {
    ...
    // December 8, 2024 ETH/USD is around $3,962
    assertEq(expected / 1e18, 3962); // WETH is 18 decimals
  }
  ...
  function test_ethToBal() public view {
    ...
    // December 8, 2024 ETH/BAL is 1 ETH is around 1062 BAL tokens
    assertEq(expected / 1e18, 1062); // WETH and BAL are 18 decimals
  }
  ...
  function test_balTo80BAL20WETH() public view {
    ...
    // December 8, 2024 BAL/USD should be around 2,10 at 100 units traded, 29 units expected.
    assertEq(expected / 1e18, 29); // WETH and BAL are 18 decimals
  }
}
