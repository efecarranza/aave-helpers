 ...
 * @author BGD Labs
 */
abstract contract AaveV3CapsUpdate {
  using Address for address;

  IGenericV3ListingEngine public immutable LISTING_ENGINE;

  uint256 internal constant SUPPLY_CAP_NO_CHANGE = 4242424242424242;
  uint256 internal constant BORROW_CAP_NO_CHANGE = 4242424242424242;
