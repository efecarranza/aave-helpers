...
contract V2RateStrategyFactoryTest is ProtocolV2TestBase {
  ...
  function testCreateStrategies() public {
    address strategyAddress = AaveV2Ethereum.POOL.getReserveData(AaveV2EthereumAssets.AAVE_UNDERLYING).interestRateStrategyAddress;
    ...
    IV2RateStrategyFactory.RateStrategyParams[] memory rateStrategyParams = new IV2RateStrategyFactory.RateStrategyParams[](1);
  ...
  function testMultipleCreateStrategies() public {
    address strategyAddress = AaveV2Ethereum.POOL.getReserveData(AaveV2EthereumAssets.USDC_UNDERLYING).interestRateStrategyAddress;
    IDefaultInterestRateStrategy strategy = IDefaultInterestRateStrategy(
      strategyAddress
    );
